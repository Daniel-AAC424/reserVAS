...
BEGIN
    IF EXISTS (
        ...
        WHERE 
            (i.hora_inicio BETWEEN r.hora_inicio AND r.hora_salida) OR
            (i.hora_salida BETWEEN r.hora_inicio AND r.hora_salida) OR
            (r.hora_inicio BETWEEN i.hora_inicio AND i.hora_salida)
    )
    BEGIN
...
VALUES ('AL100224', 'EBLE', 'Computo 5', 'PC0_C5', CAST(GETDATE() AS DATE), '10:00', '11:00');
